...
router.post("/", verifyToken, checkAdmin, uploadMultiple, addTrip); // Create new trip

router.put("/:id", verifyToken, checkAdmin, uploadMultiple, updateTrip); // Update trip

router.delete("/:id", verifyToken, checkAdmin, deleteTrip); // Delete trip
